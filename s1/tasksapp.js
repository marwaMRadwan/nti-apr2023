...
//json => language js obj notat. => [] {[]} [{}]
// convert to string   , string => json
// const data = [
//     {title:`task 1`, content:`content 1`},
//     {title:`task 2`, content:`content 2`},
//     {title:`task 3`, content:`content 3`},
// ]
//JSON.stringify => covert json to string
...
const addTask = () =>{
    const task = {
        ...
        content: prompt(`please enter content`)
    }
...
const showAllTasks = () =>{
    ...
    for(let i=0; i< data.length; i++){
        console.log(data[i].title, ` - `, data[i].content)
    }
}
// addTask()
// showAllTasks()
